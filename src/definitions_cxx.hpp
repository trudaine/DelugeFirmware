...
constexpr int32_t kNumIterancePresets = 68;                // 1of2 through 8of8 + 33 skip-N presets
constexpr int32_t kCustomIterancePreset = 69;              // The "CUSTOM" iterance value is right after the last preset
